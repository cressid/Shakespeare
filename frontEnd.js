...
var shakesData = function(){
	...
	var setup = function(){
		...
		var selectAPlay = $("<button class = 'btn btn-large selectAPlay'>Change Plays</button>");
		var selectData = $("<span><button class = 'btn btn-large selectData'>Change Data</button></span>");
	...
	//THIS WILL SELECT THE DATA TO GRAPH
		...
		buttonDiv.append(selectData,selectAPlay);
		...
		$('.selectAPlay').click(function(){
			...
			$('.buttonDiv').css('z-index',11);
			$('.displayDiv').css('z-index',0);
			$('.displayDiv').animate({opacity: .1}, 800, function(){});
			dataDiv.append(Go);
			
			Go.animate({opacity:"1 !important;"}, 800,function(){});
		...
		var initial=$("<div class='visual initial' data-plays=Macbeth data-vis=charTimelines id =viz ></div>"); 
